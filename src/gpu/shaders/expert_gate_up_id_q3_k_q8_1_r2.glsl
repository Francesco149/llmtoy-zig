#version 450
// Two-row workgroup variant of expert_gate_up_id_q3_k_q8_1.glsl.
//
// Each 64-thread workgroup contains two 32-lane row subgroups. This preserves
// the original one-subgroup-per-output-row math while halving the number of
