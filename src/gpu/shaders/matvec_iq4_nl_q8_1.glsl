#version 450
// IQ4_NL (weights) x Q8_1 (activations) matvec.
//
// IQ4_NL uses a non-linear 16-entry lookup table, so this cannot use packed
// integer dot directly. It still removes measured CPU fallback work for Gemma4
// expert-down tensors by keeping the row dequant/dot on the GPU.
